                                        ...
                                        <form action="{{route('confirm.withdraw.store')}}" method="post">
                                            ...
                                            <div class="panel-body table-responsive text-center">
                                                <ul class="list-group">
                                                    ...
                                                    <li class="list-group-item">Request for Withdraw Amount: {{$general->symbol}} <strong>{{$amount}}</strong> </li>
                                                    <li class="list-group-item" style="color: red">Charge : {{$general->symbol}} <strong>{{$charge}}</strong> </li>
                                                    <li class="list-group-item">Total Withdraw Amount: {{$general->symbol}}<strong> {{$amount - $charge}}</strong> </li>
