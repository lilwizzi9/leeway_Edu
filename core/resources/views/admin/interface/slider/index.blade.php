...
@section('main-content')
    <div class="page-content-wrapper">
        <div class="page-content">
            <h3 class="page-title uppercase bold"> Slider Settings</h3>
            <hr>
            @if (count($errors) > 0)
                <div class="row">
                    <div class="col-md-06">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light bordered">
                        ...
                        <button class="btn purple" type="button" data-toggle="modal" data-target="#addModal">Add Slider</button>
                                  ...
                                  <span class="btn btn-large btn-alpha">Upload Image</span>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-md-12">
                                                                <div class="col-md-12">
                                                                    <label class="control-label">Head Text</label>
                                                                    <input class="form-control text-capitalize" type="text" required name="heading">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-md-12">
                                                                <div class="col-md-12">
                                                                    <label class="control-label">Small Text (Description Type)</label>
                                                                    <input class="form-control text-capitalize" type="text" required name="description">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
