                    ...
                    <div class="portlet box purple">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                ...
                                @else
                                <button type="button" class="btn btn-danger" style="background-color:red !important;"><a href="{{route('ticket.admin.close', $ticket_object->id )}}" style="color:white;">Click To Close Ticket</a></button>
                                @endif
