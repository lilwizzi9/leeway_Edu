                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tr>
                                                <th>Member Name:</th>
                                                <td><a href="{{route('user.view', $data->memeber->id)}}">{{$data->memeber->first_name}} {{$data->memeber->last_name}}</a></td>
                                            </tr>
...
<!-- 
                                            <tr>
                                                <th>PerfectMoney</th>
                                                <td> {{ isset($data->memeber->perfect_detail)?$data->memeber->perfect_detail:'No Detail' }}</td>
                                            </tr>
                                            <tr>
                                                <th>BTC Wallet</th>
                                                <td> {{ isset($data->memeber->btc_detail)?$data->memeber->btc_detail:'No Detail' }}</td>
                                            </tr>
 -->
                                        </table>
                                        ...
                                        <p style="color: red">{{$data->method_name}} method Deleted</p>
                                            @else
                                        <p style="color: red">Charge Already taken. Send {{ $data->amount - $data->charge}} {{$amo->currency}} To The User</p>
                                        @endif
                                    </div>

                                    <div class="col-md-6">
                                        <form class="form-horizontal" method="post" action="{{route('withdraw.process', $data->id)}}">
                                            {{csrf_field()}}
                                           <div class="form-body">
                                               <div class="row">
                                                   <div class="col-md-12">
                                                       ...
                                                       <button type="submit" name="status"  value="3" class="btn red pull-right">Refund</button>
                                                   </div>
                                               </div>
                                           </div>
                                        </form>
