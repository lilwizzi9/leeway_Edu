                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-heading">
                                    ...
                                    <div class="panel-title" style="color: #0e265d;">Withdraw By BUSD Token<!-- {{$gate->name}} --></div>

                                </div>

                                <div class="panel-body text-center">
                                    
                                  	<h4>My BUSD Balance: <?=Auth::user()->balance;?> BUSD</h4>
                              ...
                              <?php else: ?>
                               <button class="btn btn-primary btn-block" data-toggle="modal" data-target="#buyModal{{$gate->id}}">Via BUSD Token  <!-- {{$gate->name}} --> </button>
                           <?php endif;?>
               ...
               <div id="buyModal{{$gate->id}}" class="modal fade" role="dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Withdraw via <strong>BUSD Token<!-- {{$gate->name}} --></strong></h4>
                    ...
                    <form method="POST" action="{{route('withdraw.preview.user')}}">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="text-center">
                               ...
                               <p style="color: red">Charge for withdraw Amount: {{$gate->chargefx}} BUSD</p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                   ...
                                   <input type="text" name="amount" class="form-control" id="amount" placeholder="AMOUNT YOU WANT TO WITHDRAW | Minimum BUSD" required>

                                    <span class="input-group-addon"> BUSD </span>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="WithdrawBUSD" class="btn btn-primary">Withdraw</button>
            ...
            @endforeach
                       <div class="col-md-4 col-sm-6 col-xs-12">
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body text-center">
									<h4>My LEWT Balance: <?=Auth::user()->lewt_balance;?> BUSD</h4>
                                    <!--<img src="https://hadaftech.dsvinfo.online/assets/images/withdraw/1632463542.jpg" style="width:100%">-->
                                ...
                                <div class="panel-footer">
                                 ...
                                 ?>
                                  @if($total_lewtToken>3500000)
                                   <button class="btn btn-primary btn-block"><a href="{{ url('add_withdraw_leeway') }}">Via LEEWAY Token</a> </button>
                                 @else
                                   <button class="btn btn-primary btn-block" disabled>Via LEEWAY Token </button>
                                 @endif
...
$(document).ready(function () {
    ...
    $(document).on("click", "#WithdrawBUSD", function (event) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (jsonRes == 0) {
                    toastr.error('Oops!. your BUSD balance is low please check BUSD balance and input correct value.');
                }
                else{
        ...
        if (typeof window.ethereum !== 'undefined') {
            ...
            contractInstance.methods.triggerBusdWithdraw(loggedInUser, amount, busdHash).send({
