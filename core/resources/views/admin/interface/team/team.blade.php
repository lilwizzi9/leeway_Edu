            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-black bold uppercase">Users News</span>
                    </div>
                    <div class="actions">
                        <a class="btn btn-circle  btn-primary"  data-toggle="modal" data-target="#addsocial">
                           <i class="icon-plus"></i> New News
                        </a>
                    </div>
                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form role="form" method="POST" action="{{route('team.update.update', $data->id)}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">News Popup Or List</label>
                                        <div class="col-md-12">
                                            <strong style="color:red; font-size:12px;">If you want this new show on popup type: Popup If no type: List</strong>
                                            <input type="text" class="form-control" value="{{$data->type}}"  required name="type" >
                                        </div>
                                    </div>
